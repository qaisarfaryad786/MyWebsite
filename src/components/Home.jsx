...
const Home = () => {
  return (
    <div id="Home" className="flex flex-col items-center pt-20 bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] h-screen">
      ...
      <p className="text-white text-2xl font-bold font-herofont">
        make content <span className="text-sky-500">about it!</span>
      </p>
